...
write.csv(myData[,c(2,3,6)], file="data/registrations.csv", row.names = FALSE)
...
A total of `r length(myData$COMPETENCY)` registrations have been completed as of `r format(Sys.Date(),format="%B %d, %Y")`. This includes a total of `r length(unique(myData$COURSE))` different courses.  
